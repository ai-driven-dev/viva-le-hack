...
3. Quand Memory Agent revient → Récupère météo et news via tes outils
4. transfer_to_softMorningPodcastAgent avec CONTEXTE COMPLET : "Voici TOUTES les données : [santé] + [historique] + [météo] + [news]. Raconte le podcast à l'utilisateur avec ces infos."
5. Quand Podcast Agent revient → transfer_to_alterEgo avec contexte ultra-enrichi

WORKFLOW "podcast" :
- Récupère météo et news → transfer_to_softMorningPodcastAgent → retour

RÔLE CLÉS :
- Collecte TOUTES les données (santé, mémoire, météo, news)
...
- Coordonne efficacement sans conversation longue`,
  ...
  tools: [getWeather, searchGoodNews],
  handoffDescription:
